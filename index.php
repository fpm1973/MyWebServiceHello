...
<head>
    ...
    <style>
        ...
        .container {
            background-color: #ffffff; /* Fundo branco para a caixa de conteúdo */
            padding: 40px 60px;
        ...
        h1 {
            color: #4CAF50; /* Cor verde vibrante */
            font-size: 2.5em;
            margin-bottom: 5px;
        }
        h2 {
        ...
        p {
            ...
            font-size: 1.1em;
            padding: 8px 15px;
            background-color: #e8f5e9; /* Fundo suave para o cargo */
            border-radius: 6px;
...
<body>
    ...
    <div class="container">
        <?php
        echo "<h1>Olá Mundo - Teste de WebService</h1>";
        echo "<h2>Sou o Fernando Monteiro</h2>";
        echo "<p>Activity Provider — Projeto Inven!RA</p>";
        ?>
    </div>
